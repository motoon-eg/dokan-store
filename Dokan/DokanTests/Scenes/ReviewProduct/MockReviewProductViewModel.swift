...
class MockReviewProductViewModel {
    ...
    public func loadReviews() {
        ...
        do {
            let allProductData = try JSONSerialization.data(withJSONObject: Constant.mockProductReviewsJsonResponse, options: .fragmentsAllowed)
            _ = try JSONDecoder().decode(Networking.Reviews.self, from: allProductData)
...
extension MockReviewProductViewModel {
