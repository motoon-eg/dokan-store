...
extension UIFont{
    // MARK: - Bold
    class var registerTitle: UIFont{
        return UIFont(name: "DMSans-Bold", size: 25)!
    }
    
    class var coverTitle: UIFont{
        return UIFont(name: "DMSans-Bold", size: 20)!
    }
    
    class var productPrice: UIFont{
        return UIFont(name: "DMSans-Bold", size: 12)!
    }
    // MARK: - Meduim
    class var categoriesTitle: UIFont{
        return UIFont(name: "DMSans-Medium", size: 16)!
    }
    
    class var productTitle_Button_TextFeild: UIFont{
