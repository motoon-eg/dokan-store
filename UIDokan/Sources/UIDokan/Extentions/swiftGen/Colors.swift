...
internal struct ColorName {
  ...
  /// <span style="display:block;width:3em;height:2em;border:1px solid black;background:#3669c9"></span>
  /// Alpha: 100% <br/> (0x3669c9ff)
  internal static let blueOcean = ColorName(rgbaValue: 0x3669c9ff)
  /// <span style="display:block;width:3em;height:2em;border:1px solid black;background:#ff66cc"></span>
  /// Alpha: 100% <br/> (0xff66ccff)
